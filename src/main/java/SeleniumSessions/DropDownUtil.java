...
public class DropDownUtil {
	 ...
	 */
		...
		/**
		 * This mehtod is used to select the value from a drop down on the basis of given index
		 * @param element
		 * @param index
		 */
		...
		/**
		 * This method is used to get all values from drop down//total number of values in drop down: 13
